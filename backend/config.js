...
module.exports = {
  ...
  PRODUCER_CONCURRENCY: getEnv("PRODUCER_CONCURRENCY", 20, parseInt),
  CRAWL_SCHEDULED_QUEUE_CONCURRENCY: getEnv("CRAWL_SCHEDULED_QUEUE_CONCURRENCY", 8, parseInt),
  CRAWL_ADHOC_QUEUE_CONCURRENCY: getEnv("CRAWL_ADHOC_QUEUE_CONCURRENCY", 4, parseInt),
  ...
  REACT_APP_VAPID_PUBLIC_KEY: getEnv(
    "REACT_APP_VAPID_PUBLIC_KEY",
    "BL9p1LYimfzPWUfeyvAKAln9CtOLp3sDGGf36uo0AxvF7LxBYL1ty0woJJeX2yU-oVPqABP0r5pL10jOW5-wggg",
  ),
  REACT_APP_VAPID_PRIVATE_KEY: getEnv("REACT_APP_VAPID_PRIVATE_KEY", "KYA-2glnm36uWfM8MeHwsPkCOb4w9yRN_2y67A84S5I"),
  WEB_PUSH_CONTACT: getEnv("WEB_PUSH_CONTACT", "mailto:somebody@example.com"),
};
