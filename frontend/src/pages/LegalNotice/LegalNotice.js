...
import { Anchor, Button, Divider, Grid, Layout, Typography } from "antd";
...
const LegalNotice = () => {
  ...
  return (
    <DefaultLayout containerClass="legal-notice">
      <Desktop>
        <Sider>
      ...
      <Content className="container">
        ...
        <div className="body">
          ...
          <p>
            ...
            any or all Agreements: &quot;Client&quot;, &quot;You&quot; and &quot;Your&quot; refers to you, the person
            accessing this website and accepting the Company&apos;s terms and conditions. &quot;The Company&quot;,
            ...
            necessary to undertake the process of our assistance to the Client in the most appropriate manner, whether
            by formal meetings of a fixed duration, or any other means, for the express purpose of meeting the
            Client&apos;s needs in respect of provision of the Company&apos;s stated services/products, in accordance
            with and subject to, prevailing law of . Any use of the above terminology or other words in the singular,
          ...
          <p>
            ...
            confidentiality of your account and password, and You agree to accept responsibility for all activities that
            occur under your account or password. You agree that the information You provide to MangaBookmark, whether
            at registration or at any other time, will be true, accurate, current, and complete. You also agree that You
            will ensure that this information is kept accurate and up-to-date at all times. If You have reason to
            believe that your account is no longer secure (e.g., in the event of a loss, theft or unauthorized
            disclosure or use of your account ID or password), then You agree to immediately notify MangaBookmark at
            &nbsp;
          ...
          <p>
            ...
            of the linking party and its products or services; and (c) fits within the context of the linking
            party&apos;s site.
          </p>
          ...
          <p>
            You are allowed create frames around our Web pages or use other techniques that alter in any way the visual
          ...
          <p>
            ...
            licensors, disclaim any and all warranties and conditions, whether statutory, express or implied, including,
            but not limited to, all implied warranties of merchantability, fitness for a particular purpose, title, and
            non-infringement. No advice or information, whether oral or written, obtained by you from MangaBookmark or
            through the website will create any warranty not expressly stated herein.
          </p>
          <p>
            <b>Content.</b> MangaBookmark, and its suppliers, licensors, and affiliates, do not warrant that the website
            or any data, user content, functions, or any other information offered on or through the website will be
            uninterrupted, or free of errors, viruses or other harmful components, and do not warrant that any of the
          ...
          <p>
            ...
            use) the website or any reference sites, or any other interactions with MangaBookmark, even if MangaBookmark
            or a MangaBookmark authorized representative has been advised of the possibility of such damages. applicable
            law may not allow the limitation or exclusion of liability or incidental or consequential damages, so the
            above limitation or exclusion may not apply to you. in such cases, MangaBookmark&apos;s liability will be
          ...
          <p>
            If you are located outside the United States of America (US) and choose to provide information to us, please
            note that we transfer the data, including Personal Data, to US and process it there.
          </p>
          <p>
