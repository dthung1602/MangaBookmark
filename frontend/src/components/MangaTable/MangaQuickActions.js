...
const MangaQuickActions = ({ manga, updateMangaDone }) => {
  ...
  const disableMarkAll = manga.shelf === REREAD ? false : manga.chapters.every((ch) => ch.isRead);

  return (
    <div className="manga-quick-actions">
      <MarkAllButton isLoading={isChapterLoading} disabled={disableMarkAll} markAll={markAll} />
